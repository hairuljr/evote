    ...
    BaseRoute::group([
      ...
      BaseRoute::group([
        ...
        BaseRoute::group(['as' => 'account.', 'prefix' => 'account'], function () {
          BaseRoute::get('/admin/generate', [UserAdminController::class, 'generate'])->name('admin.generate');
          BaseRoute::post('/admin/store-generate', [UserAdminController::class, 'storeGenerate'])->name('admin.store.generate');
